...
public class ColorPickerActivity extends AppCompatActivity {
    public static final  String BUNDLE_KEY_COLOR_INT = "com.example.marty.colorInt";
    public static final String BUNDLE_KEY_COLOR_NAME = "com.example.marty.colorName";
